function [ ROI ] = processroisupervised( ROI, params)
%[ ROI ] = processroisupervised( ROI, params ) process - e.g. sort - a single region 
...
fprintf('Current ROI contains %g true neurons.\n',N_NEURONS);
